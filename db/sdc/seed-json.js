...
writeNTimes = (writer, min, max, callback) => {
  ...
  const writeFile = () => {
    ...
    do {
        ...
        dataString += `"relatedPlaces":[${relatedPlaceID2},${relatedPlaceID2},${relatedPlaceID3},${relatedPlaceID4},${relatedPlaceID5},${relatedPlaceID6},${relatedPlaceID7},${relatedPlaceID8},${relatedPlaceID9},${relatedPlaceID10},${relatedPlaceID11},${relatedPlaceID12}]`;
        dataString += `}\n`;
